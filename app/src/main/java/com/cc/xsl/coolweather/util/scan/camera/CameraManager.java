...
package com.cc.xsl.coolweather.util.scan.camera;
...
import com.cc.xsl.coolweather.util.scan.PlanarYUVLuminanceSource;
...
//			}
			...
			//} else {
			//	framingRect = new Rect(topOffset, leftOffset, topOffset + height, leftOffset + width);
			//}
