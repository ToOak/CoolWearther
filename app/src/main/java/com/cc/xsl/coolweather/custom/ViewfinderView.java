package com.cc.xsl.coolweather.custom;
...
import com.cc.xsl.coolweather.util.scan.camera.CameraManager;
...
public final class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(frame.left - 10, frame.top - 10, frame.left + 10,
                frame.top - 5, paint);
        canvas.drawRect(frame.left - 10, frame.top - 10, frame.left - 5,
                frame.top + 10, paint);
        canvas.drawRect(frame.right - 10, frame.top - 10, frame.right + 10,
                frame.top - 5, paint);
        canvas.drawRect(frame.right + 5, frame.top - 10, frame.right + 10,
                frame.top + 10, paint);
        canvas.drawRect(frame.left - 10, frame.bottom - 10, frame.left - 5,
                frame.bottom + 10, paint);
        canvas.drawRect(frame.left - 10, frame.bottom + 5, frame.left + 10,
                frame.bottom + 10, paint);
        canvas.drawRect(frame.right + 5, frame.bottom - 10, frame.right + 10,
                frame.bottom + 10, paint);
        canvas.drawRect(frame.right - 10, frame.bottom + 5, frame.right + 10,
                frame.bottom + 10, paint);
...
//				canvas.drawRect(frame.left, middle - 1, frame.right,
//						middle + 1, paint);
//			} else {
